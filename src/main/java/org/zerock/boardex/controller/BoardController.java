...
public class BoardController {
    ...
    @PreAuthorize("hasRole('USER')") //특정 사용자에게만 권한설정
    ...
    //게시글 수정하기
    //@PreAuthorize:사용자 권한 검사하는 어노테이션,로그인한 사람과 작성자가 같다면, modify(수정하기)가능하게 해달라는 뜻으로 사용.
    ...
    public String remove(BoardDTO boardDTO, RedirectAttributes redirectAttributes){
        ...
        // board/list로 이동, 정상 사용자가 아니라면 로그인화면으로 이동
        return "redirect:/board/list";
    }
